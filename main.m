...
num_instances=1000; % number of instances desired 
num_lambdas=100;
...
[error,av_error,logloss,av_logloss,num_lambdas,lambdas,stabilities,hat_pf,A]=experiment(data,labels,M,num_lambdas);
